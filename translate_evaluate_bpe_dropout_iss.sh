...
dest_dir=output_bpe_dropout_iss
mkdir -p $dest_dir

python translate.py --data bpe_dropout/prepared_data --checkpoint-path checkpoints_bpe_dropout_iss/checkpoint_best.pt --output \
